...
Retourne un vrai ou faux qui indique si la lettre reçu se trouve dans le tableau reçu. Vous ne pouvez pas utiliser les fonctions de recherches comme `find`, `in` ou autre.
